...
export default function FaultyTerminal({
  ...
  // This function now calculates mouse position relative to the viewport
  ...
  useEffect(() => {
    ...
    // CRITICAL FIX: Attach the listener to the whole window
    if (mouseReact) window.addEventListener("mousemove", handleMouseMove);

    return () => {
      cancelAnimationFrame(rafRef.current);
      resizeObserver.disconnect();
      // CRITICAL FIX: Remove the listener from the whole window
